...
public class Step02IfForTest extends PlainTestCase {
    ...
    public void test_for_inti_basic() {
        ...
        log(sea); // your answer? => dockside(〇)
    }
    ...
    public void test_for_foreach_basic() {
        ...
        log(sea); // your answer? => magiclamp(〇)
    }
